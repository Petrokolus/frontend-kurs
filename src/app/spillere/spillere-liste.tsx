...
export default function SpillereListe({ spillere }: Props) {
  return (
    <div className="grid grid-cols-2 gap-4">
      {spillere.map((spiller) => ( //map()-funksjonen funker som en løkke som går gjennom alle spillerne i arrayet, og for hver spiller kjører den koden som er inni klammeparentesene. 
